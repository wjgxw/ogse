        ...
        function this = IMPULSED(varargin)
            ...
            switch inputStructure.modelName
                ...
                case 'impulsed_vin_d_Dex'                                                                                      % [vin, d, Dex]
                    ...
                    this.defaultFitopts.x0 = [0.5, 20, 1.5]' ;  this.defaultFitopts.lb = [0, 0, 0]' ; this.defaultFitopts.ub = [1, 50, 3]' ; 
                ...
                case 'impulsed_vin_d_Dex_Din'                                                                               % [vin, d, Dex, Din]
                    ...
                    this.defaultFitopts.x0 = [0.5, 20, 1.5, 1.5]' ; this.defaultFitopts.lb = [0, 0, 0, 0]' ; this.defaultFitopts.ub = [1, 50, 3,3]' ; 
